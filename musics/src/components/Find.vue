			...
			<van-tabs v-model="active" class='content'>
				...
				<van-tab title="主播电台">
					<div class="conten">
						...
						<van-swipe-item>
							<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-07.jpg" />

						</van-swipe-item>
						<van-swipe-item>
							<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-08.jpg" />

						</van-swipe-item>
						<van-swipe-item>
							<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-09.jpg" />

						</van-swipe-item>
						<van-swipe-item>
							<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-10.jpg" />
						</van-swipe-item>
						<van-swipe-item>
							<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-11.jpg" />
						</van-swipe-item>
					</van-swipe>
