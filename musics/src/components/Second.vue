<template>
	<div class="second">
		...
		<van-row class='like1'>
			<van-col span='11' class='bg'><img src="http://127.0.0.1:8085/images/gedan-02.jpg" /></van-col>
		</van-row>
		<div class="m">
		...
		<ul class="chart">
			...
			<li v-for="(item,index) in list" :key='index'@click="goState({name:'Play',params:{pid:item.id,item:list}})" ><b>{{index+1}}</b>
