	...
	<div class="frist">
		<div>
			<van-swipe :autoplay="3000" indicator-color="white" class='swipe'>
				<van-swipe-item>
					<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-01.jpg" />

				</van-swipe-item>
				<van-swipe-item>
					<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-02.jpg" />

				</van-swipe-item>
				<van-swipe-item>
					<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-03.jpg" />

				</van-swipe-item>
				<van-swipe-item>
					<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-04.jpg" />
				</van-swipe-item>
				<van-swipe-item>
					<img class="swipe1" src="http://127.0.0.1:8085/images/wyy-05.jpg" />
				</van-swipe-item>
			</van-swipe>
		</div>
